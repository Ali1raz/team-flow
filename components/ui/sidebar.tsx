    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          style={
            {
              // Left sidebar width — stays fixed regardless of right sidebar state
              "--sidebar-width": SIDEBAR_WIDTH,
              // Right sidebar gets its own variable so it never interferes with
              // the left sidebar width or the gap calculations that use --sidebar-width
    ...
    <SidebarInnerContext.Provider value={side}>
      ...
      >
        <div
          ...
          className={cn(
            // Use --right-sidebar-width for the right sidebar gap so it doesn't
            // inherit the left sidebar's 16rem and cause layout overflow
            side === "right"
        ...
        <div
          ...
          className={cn(
            // Right sidebar uses --right-sidebar-width for its own panel width,
            // keeping the left sidebar's fixed width untouched
            side === "right"
